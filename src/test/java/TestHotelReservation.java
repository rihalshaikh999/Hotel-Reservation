...
public class TestHotelReservation
{
    @Test
    public void UC1() {
        HotelParameter ob1=new HotelParameter("Lakewood",110.0,parseDate("10/sep/2020"), parseDate("11/sep/2020"),110.0, 90.0, 3);//actual
        Assert.assertEquals("Lakewood", ob1.hotelName);
        Assert.assertEquals(110.0, ob1.price);
        HotelParameter ob2=new HotelParameter("Bridgewood", 160.0, parseDate("10/sep/2020"), parseDate("11/sep/2020"),150.0, 50.0, 4);//actual
        Assert.assertEquals("Bridgewood", ob2.hotelName);
        Assert.assertEquals(160.0, ob2.price);
        HotelParameter ob3=new HotelParameter("Ridgewood", 210.0, parseDate("10/sep/2020"), parseDate("11/sep/2020"),220.0,150.0, 5);//actual
...
//            Assert.assertEquals("11/sep/2020", ob1.endDate);
    ...
    public void UC3()
    {
        HotelParameter ob1 = new HotelParameter("Lakewood", 110.0, parseDate("10/Sep/2020"), parseDate("11/Sep/2020"), 110.0, 90.0, 3);
        Assert.assertEquals("Lakewood", ob1.hotelName);
        Assert.assertEquals(220.0, ob1.calRate(ob1.startDate, ob1.endDate), 0.01);

        HotelParameter ob2 = new HotelParameter("Bridgewood", 160.0, parseDate("10/Sep/2020"), parseDate("11/Sep/2020"), 150.0, 50.0, 4);
        Assert.assertEquals("Bridgewood", ob2.hotelName);
        Assert.assertEquals(300.0, ob2.calRate(ob2.startDate, ob2.endDate), 0.01); // Fix here

        HotelParameter ob3 = new HotelParameter("Ridgewood", 210.0, parseDate("10/Sep/2020"), parseDate("11/Sep/2020"), 220.0, 150.0, 5);
        Assert.assertEquals("Ridgewood", ob3.hotelName);
